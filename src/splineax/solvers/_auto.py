...
class AutoSparseLinearSolver(AbstractLinearSolver[_State]):
    ...
    def _solver_for_state(self, state: Any) -> Pardiso | KLU | Spsolve:
        ...
        the class docstring), and later calls on that same state must keep using `KLU`.
        """
